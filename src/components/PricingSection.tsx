...
const PricingSection = () => {
  const features = [
    { name: 'Live Channels', standard: '15,000+', premium: '30,000+', icon: Tv },
    { name: 'Movies & Series (VOD)', standard: '60K+', premium: '120K+', icon: Film },
    { name: 'Hotiptv App', standard: true, premium: true },
    { name: 'Ibo Player App', standard: true, premium: true },
    { name: 'Instant Activation', standard: true, premium: true },
    { name: 'Netflix, Prime, Disney+', standard: true, premium: true },
    { name: 'All Sports Channels', standard: true, premium: true },
    { name: 'Catch-up & EPG', standard: true, premium: true },
    { name: 'UHD, FHD, HD Quality', standard: true, premium: true },
    { name: 'Anti-Freeze™ Technology', standard: '9.8', premium: '10.0' },
    { name: 'Privacy Protection + VPN', standard: false, premium: true, icon: Shield },
    { name: '24/7 Support', standard: true, premium: true, icon: Headphones },
    { name: 'Money Back Guarantee', standard: '7 Days', premium: '30 Days' },
  ];
  ...
  const plans = [
    {
      ...
      color: 'christmas-red',
      options: [
        { duration: '12 Months', price: '39.99', originalPrice: '119', discount: '66%', link: 'https://order.modeiptv.ca/step/checkout-12-months-iptv-subscriptions-2/' },
        { duration: '24 Months', price: '79.99', originalPrice: '199', discount: '60%', link: 'https://order.modeiptv.ca/step/checkout-24-month-iptv-subscriptions-2/' },
      ],
    },
    {
      type: 'premium',
      ...
      popular: true,
      options: [
        { duration: '12 Months', price: '59.99', originalPrice: '179', discount: '66%', link: 'https://order.modeiptv.ca/step/checkout-12-months-iptv-premium-subscriptions-2/', popular: true },
        { duration: '24 Months', price: '99.99', originalPrice: '259', discount: '61%', link: 'https://order.modeiptv.ca/step/checkout-24-months-iptv-premium-subscriptions-2/' },
      ],
    },
  ];
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-3 gap-4 mb-2">
              ...
              {plans.map((plan) => (
                <div 
                  key={plan.type}
                  className={`relative text-center p-6 rounded-t-2xl border-t border-x ${
                    plan.popular 
                ...
                >
                  ...
                  <div className="flex items-center justify-center">
                    {typeof feature.premium === 'boolean' ? (
                      feature.premium ? (
                        <Check className="w-5 h-5 text-christmas-gold" />
                      ) : (
                        <X className="w-5 h-5 text-muted-foreground/50" />
                      )
                    ) : (
                      <span className="text-sm font-semibold text-christmas-gold">{feature.premium}</span>
                    )}
                  </div>
                </div>
              ))}
              ...
              {plans.map((plan) => (
                <div 
                  ...
                  className={`rounded-2xl p-6 border ${
                    plan.popular 
                      ? 'bg-gradient-to-br from-christmas-gold/10 to-christmas-gold/5 border-christmas-gold/50' 
                ...
                >
                  ...
                  <div className="space-y-4">
                    {plan.options.map((option, idx) => (
                      ...
                      >
                        {option.popular && (
                          <span className="absolute -top-2 right-4 bg-christmas-red px-2 py-0.5 rounded text-[10px] font-bold text-white">
                            BEST VALUE
                          </span>
                        )}
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              ...
                              <div className="flex flex-col">
                                ...
                                <span className={`text-xs font-bold ${
                                  plan.type === 'premium' ? 'text-christmas-gold' : 'text-christmas-green'
                                }`}>{option.discount} OFF</span>
                              </div>
                            </div>
                          </div>
                          <a href={option.link} target="_blank" rel="noopener noreferrer">
                            <Button 
                              variant={plan.type === 'premium' ? 'accent' : 'hero'}
                              size="lg"
