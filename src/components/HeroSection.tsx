...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-28 pb-20">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-christmas-green/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '-3s' }} />
      ...
      <div className="absolute bottom-32 right-10 text-4xl animate-float" style={{ animationDelay: '-5s' }}>❄️</div>
